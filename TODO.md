...
- [ ] Re-review entries currently marked blocked before designing host work.
  ...
  already cover parts of AoE2DE, COTM, Borderlands, TUNIC, Circuit Superstars,
  and other reported blockers. Preserve the residual host gap only after
  removing these false premises.
