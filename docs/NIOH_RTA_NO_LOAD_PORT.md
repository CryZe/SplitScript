...
| Poll at 29 Hz | `setTickRate(29)` after recognizing a supported build |
...
silently reading arbitrary memory after a game update. Detach restores the
ordinary 1 Hz cadence.
