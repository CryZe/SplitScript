...
pub(super) const DESCRIPTORS: &[RuntimeHelperDescriptor] = &[
    ...
    helper!(FileOpenReadOnly, (StringValue) -> (I32), deps [], imports [WasiFdPrestatGet, WasiFdPrestatDirName, WasiPathOpen], build_file_open_read_only),
    ...
    helper!(UnityGetFieldOffset, (I64, Standard(StdlibTypeId::UnityClass), StringValue) -> (I32, I64), deps [CStringEquality, BackingFieldEquality], imports [ProcessRead], build_unity_get_field_offset),
    helper!(UnityGetFieldAny, (I64, Standard(StdlibTypeId::UnityClass), StringArray) -> (I32, Standard(StdlibTypeId::UnityField)), deps [UnityGetFieldOffset], imports [], build_unity_get_field_any),
