...
pub(super) const DESCRIPTORS: &[RuntimeHelperDescriptor] = &[
    ...
    helper!(UnityGetFieldOffset, (I64, Standard(StdlibTypeId::UnityClass), StringValue) -> (I32, I64, I64), deps [CStringEquality, BackingFieldEquality], imports [ProcessRead], build_unity_get_field_offset),
