//! PlayStation hardware-address translation.
...
const BACKEND_POINTER_PATH_64: i32 = 5;
...
pub(super) fn compile_translate_address(
    ...
    let base = 4;
    let backend = 5;
    let emulator_type = gc.standard_index(StdlibTypeId::PS1Emulator);
    ...
    function
        ...
        .instruction(&Instruction::I32Const(0x8000_0000_u32 as i32))
        ...
        .instruction(&Instruction::End)
        .instruction(&Instruction::LocalGet(address))
        .instruction(&Instruction::I32Const(0x8180_0000_u32 as i32))
    ...
    function
        ...
        .instruction(&Instruction::StructGet {
            struct_type_index: emulator_type,
            field_index: gc
                .standard_field_index(crate::stdlib::StdlibFieldId::PS1EmulatorAuxiliary1),
        })
        .instruction(&Instruction::LocalSet(base));
    ...
    function
        ...
        .instruction(&Instruction::Else)
        .instruction(&Instruction::LocalGet(backend))
        .instruction(&Instruction::I32Const(BACKEND_POINTER_PATH_64))
        .instruction(&Instruction::I32Eq)
        .instruction(&Instruction::If(BlockType::Empty));
    emit_process_read(&mut function, abi, abi_read, base, 8);
    function
    ...
    function
        ...
        .instruction(&Instruction::StructGet {
            struct_type_index: emulator_type,
            field_index: gc
                .standard_field_index(crate::stdlib::StdlibFieldId::PS1EmulatorAuxiliary2),
        })
        .instruction(&Instruction::I64Add)
        .instruction(&Instruction::LocalSet(base));
    emit_process_read(&mut function, abi, abi_read, base, 8);
