//! Sega Master System and Game Gear hardware-address translation.
...
pub(super) fn compile_translate_address(
    ...
    let base = 4;
    let backend = 5;
    let emulator_type = gc.standard_index(StdlibTypeId::SMSEmulator);
    ...
    function
        ...
        .instruction(&Instruction::I32Const(0xc000))
        ...
        .instruction(&Instruction::End)
        .instruction(&Instruction::LocalGet(address))
        .instruction(&Instruction::I32Const(0xe000))
    ...
    function
        ...
        .instruction(&Instruction::StructGet {
            struct_type_index: emulator_type,
            field_index: gc
                .standard_field_index(crate::stdlib::StdlibFieldId::SMSEmulatorAuxiliary),
        })
