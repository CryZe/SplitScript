//! Nintendo Wii hardware-address translation.
...
pub(super) fn compile_translate_address(
    ...
    let base = 4;
    let backend = 5;
    let emulator_type = gc.standard_index(StdlibTypeId::WiiEmulator);
    ...
    function
        ...
        .instruction(&Instruction::StructGet {
            ...
            field_index: gc.standard_field_index(crate::stdlib::StdlibFieldId::WiiEmulatorBackend),
        })
        ...
        .instruction(&Instruction::StructGet {
            struct_type_index: emulator_type,
            field_index: gc
                .standard_field_index(crate::stdlib::StdlibFieldId::WiiEmulatorAuxiliary),
        })
    ...
    function
        ...
        .instruction(&Instruction::StructGet {
            struct_type_index: emulator_type,
            field_index: gc.standard_field_index(crate::stdlib::StdlibFieldId::WiiEmulatorMem1),
        })
        .instruction(&Instruction::LocalSet(base))
        .instruction(&Instruction::LocalGet(address))
        .instruction(&Instruction::I32Const(0x8000_0000u32 as i32))
        ...
        .instruction(&Instruction::Else)
        .instruction(&Instruction::LocalGet(address))
        .instruction(&Instruction::I32Const(0x9000_0000u32 as i32))
        .instruction(&Instruction::I32LtU)
        .instruction(&Instruction::LocalGet(address))
        .instruction(&Instruction::I32Const(0x9400_0000u32 as i32))
        .instruction(&Instruction::I32GeU)
        ...
        .instruction(&Instruction::StructGet {
            struct_type_index: emulator_type,
            field_index: gc.standard_field_index(crate::stdlib::StdlibFieldId::WiiEmulatorMem2),
        })
        .instruction(&Instruction::LocalSet(base))
        .instruction(&Instruction::LocalGet(address))
        .instruction(&Instruction::I32Const(0x9000_0000u32 as i32))
