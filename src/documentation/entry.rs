...
/// One renderer-independent standard-library callable entry.
///
/// Completion, hover, signature help, and the navigable reference consume this
...
impl StandardLibraryDocumentation {
    ...
    /// Full reference payload used by hover and full callable pages.
