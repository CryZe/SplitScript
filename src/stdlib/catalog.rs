...
const fn validation_fixture(item: StdlibItemId) -> &'static str {
    match item {
        ...
        | StdlibItemId::StringLastIndexOf
        ...
        | StdlibItemId::StringToAsciiUpperCase
        | StdlibItemId::StringTrimAsciiWhitespace
        | StdlibItemId::StringPadStart
        | StdlibItemId::StringPadEnd
        ...
        | StdlibItemId::StringConcat
        | StdlibItemId::StringJoin => BASIC_EXAMPLE,
        _ => BASIC_EXAMPLE,
    }
}
